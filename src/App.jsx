...
export default function App() {
  ...
  const hints = [
    '画红色圆', '画蓝色矩形', '画一只小猫', '画一棵树',
    '画黄色太阳', '画房子和树', '画玫瑰花', '画一条线',
    '清空画布', '撤销上一步',
  ]
    ...
    <div className="app">
      ...
      <main className="app-main">
        ...
        <aside className="side-panel">
          <div className="panel-section panel-voice">
            <VoiceController
          ...
          <div className="panel-section panel-hints">
            <h3>试试说</h3>
          ...
          <div className="panel-section panel-history">
            <h3>指令记录</h3>
