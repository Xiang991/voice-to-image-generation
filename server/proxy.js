...
- 每个主要物体至少用一个 &lt;linearGradient&gt; 或 &lt;radialGradient&gt;
- 有机形体用贝塞尔曲线 path（C/Q 命令），别用 circle/rect 拼凑
- 分层构造：背景（天空大地）→ 中景（主体）→ 前景（细节），用 &lt;g&gt; 分组
- 半透明阴影和高光制造立体感，不要纯色平铺
- 用十六进制色码，至少亮暗双色调
- viewBox="0 0 800 600"，主体占视口 60-80%
